...
int main(int argc, char* argv[]) 
{
    ...
    transfile::fileResponse response;
    brpc::Controller cntl;
    request.set_datetime("20230323");//no meaning in perftest
    
    
    stub.TransFile(&cntl, &request, &response, nullptr); //sync



    LOG(INFO) << "resp attachment size : " << cntl.response_attachment().size()
